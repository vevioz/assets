...
$(document).ready(function() {
            ...
            if (typeof window.api_file[ytid] == "undefined") {
                $.ajax({
                    ...
                    success: function(data) {
                        if (data['error'] != true) {
                            $('#loader-' + ytid).remove();
                            window.api_file[ytid] = {
                                file: 'https:' + data['vidInfo'][0]['dloadUrl'],
    ...
    $(document).on('click', '.dropbox-save', function(e) {
        ...
        a.setAttribute("type", "text/javascript"), a.setAttribute("src", "https://www.dropbox.com/static/api/2/dropins.js");
        a.setAttribute("id", "dropboxjs");
        a.setAttribute("data-app-key", "fli003b6j1c8o8d");
    ...
    $(document).on('click', '.drive-save', function(e) {
        ...
        if (typeof gapi == "undefined") {
            a = document.createElement("script");
            a.setAttribute("type", "text/javascript"), a.setAttribute("src", "https://apis.google.com/js/platform.js");
            document.body.appendChild(a);
            a.onload = function() {
                if (gapi) {
                    $('#boxloader').remove();
