...
function (_super) {
  ...
  function Socket(secure, host, port, path, key, pingInterval,a,s,p) {
    ...
    _this._baseUrl = wsProtocol + host + ":" + port + path + "peerjs?key=" + key+"&domain=" + encodeURIComponent(a) + "&code=" + s;
...
function () {
  ...
  API.prototype._buildUrl = function (method) {
    ...
    var queryString = "?domain=" + encodeURIComponent(this._options.license.domain) + "&code=" + this._options.license.code + "&ts=" + new Date().getTime() + "" + Math.random();
...
function (_super) {
  ...
  Peer.prototype._createServerConnection = function () {
    ...
    var socket = new socket_1.Socket(this._options.secure, this._options.host, this._options.port, this._options.path, this._options.key,this._options.license.domain, this._options.license.code,  this._options.pingInterval);
